<?xml version="1.0"?>
<!-- Show Differences only  at field level and above  also only test if principal profile field is required-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		...
		<html>
			...
			<body>
				<basefont face="Lucida Sans Unicode" size="2">
					...
					<h5 align="center">
						<span>Differences at field level and above for Required elements in the principal profile</span>
					</h5>
	...
	<xsl:template match="Field">
			<xsl:variable name="IsR" select="(@Optionality='R') "/>

		<xsl:if test="(Differences) and ($IsR)">
			<tr>
				<td width="30%">
					<font size="2" color="#FFFFFF"><xsl:call-template name="nbsp"/></font>
					<font size="2">
