...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html>
			<head>
				...
				<title>
				  <xsl:choose>
				     <xsl:when test="Specification/@SpecName !=''">
			...
			<body>
				<basefont face="Lucida Sans Unicode" size="2">
					...
					<table border="1" width="100%" cellspacing="0">
						...
						<xsl:if test="Specification/HL7Definition">
							<xsl:apply-templates select="Specification/HL7Definition"/>
						</xsl:if>
						<xsl:if test="Specification/DesignNote">
							<xsl:apply-templates select="Specification/DesignNote"/>
						</xsl:if>
						<xsl:if test="Specification/OtherNote">
							<xsl:apply-templates select="Specification/OtherNote"/>
						</xsl:if>
						<xsl:if test="Specification/MessageNote">
							<xsl:apply-templates select="Specification/MessageNote"/>
						</xsl:if>
						<tr>
      ...
      Type</b>
					...
					<xsl:if test="Specification/Diagrams">
					     <xsl:apply-templates select="Specification/Diagrams"/>
					</xsl:if>
			...
			<xsl:if test="@Optionality != 'NS'">
				...
				<tr>
					...
					<xsl:if test="@Repeatable[.!='Y']">
						<td width="4%">
							<b>
								<font size="2"><xsl:call-template name="nbsp"/></font>
							</b>
						</td>
						<td width="5%">
							<b>
				...
				<xsl:if test="DesignNote">
					<xsl:apply-templates select="DesignNote"/>
				</xsl:if>
				<xsl:if test="LongDescription">
					<xsl:apply-templates select="LongDescription"/>
				</xsl:if>
				<xsl:if test="OtherNote">
					<xsl:apply-templates select="OtherNote"/>
				</xsl:if>
				<xsl:if test="MessageNote">
					<xsl:apply-templates select="MessageNote"/>
				</xsl:if>
			</xsl:if>
			<!-- Optionality !='NS' -->
			<xsl:if test="@Optionality = 'NS'">
	...
	<xsl:template match="Field">
		<xsl:if test="@Optionality[.!='NS']">
			<tr>
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						<td width="10%">
							<font size="1" color="FFFFFF"><xsl:call-template name="nbsp"/></font>
							<font size="2" color="FFFFFF"><xsl:call-template name="nbsp"/></font>
						</td>
						<td width="10%">
							<font size="1" color="FFFFFF"><xsl:call-template name="nbsp"/></font>
		...
		<xsl:if test="@Optionality[.='NS']">
			<tr bgColor="C0C0C0">
				<td width="25%">
					<font size="1" color="C0C0C0"><xsl:call-template name="nbsp"/></font>
					<font size="2">
						<xsl:value-of select="@Name"/>
					</font>
				</td>
	...
	<xsl:template match="Component">
		<xsl:if test="@Optionality[.!='NS']">
			<tr>
				<td width="25%">
					<font size="2" color="#FFFFFF"><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/></font>
		...
		<xsl:if test="@Optionality[.='NS']">
			<tr bgColor="C0C0C0">
				<td width="25%">
					<font size="1" color="C0C0C0"><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/></font>
					<font size="2" color="#0000FF">
						<xsl:value-of select="@Name"/>
					</font>
				</td>
	...
	<xsl:template match="SubComponent">
		<xsl:if test="@Optionality[.!='NS']">
			<tr>
				<td width="25%">
					<font size="2" color="#FFFFFF"><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/>&#194;<xsl:call-template name="nbsp"/></font>
		...
		<xsl:if test="@Optionality[.='NS']">
			<tr bgColor="C0C0C0">
				<td width="25%">
					<font size="1" color="C0C0C0"><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/>&#194;<xsl:call-template name="nbsp"/></font>
					<font size="2" color="#FF00FF">
						<xsl:value-of select="@Name"/>
					</font>
				</td>
  ...
  padding:.75pt .75pt .75pt .75pt;height:3.75pt">
					<font color="#00CC66"><xsl:call-template name="nbsp"/></font>
	...
	<xsl:template match="HL7Definition">
		<tr bgcolor="#33CCCC" Height="5" style="border:none">
			<td width="100%" colspan="11" style="border:none">
				<font size="1">Local Element Definition: </font>
			</td>
		</tr>
		<xsl:for-each select="Paragraph">
			<tr bgcolor="#33CCCCC" Height="5" style="border:none">
				<td width="100%" colspan="11" style="width:95.4%;border:none;background:#CCFFCC;
  padding:.75pt .75pt .75pt .75pt;height:3.75pt">
					<font color="#00FFFF"><xsl:call-template name="nbsp"/></font>
					<font size="1" color="#0000FF">
		 <xsl:value-of select="translate(.,'&#160;',' ')"/>
					</font>
				</td>
	...
	<xsl:template match="DesignNote">
		<tr bgcolor="#AD0008" Height="5" style="border:none">
			<td width="100%" colspan="11" style="border:none">
				<font size="1">Design Information: </font>
			</td>
		</tr>
		<xsl:for-each select="Paragraph">
			<tr bgcolor="#33CCCCC" Height="5" style="border:none">
	...
	<xsl:template match="LongDescription">
		<tr bgcolor="#FF9200" Height="5" style="border:none">
			<td width="100%" colspan="11" style="border:none">
	...
	<xsl:template match="OtherNote">
		<tr bgcolor="#7B7D00" Height="5" style="border:none">
			<td width="100%" colspan="11" style="border:none">
				<font size="1">Other Annotation: </font>
			</td>
		</tr>
		<xsl:for-each select="Paragraph">
			<tr bgcolor="#33CCCCC" Height="5" style="border:none">
	...
	<xsl:template match="MessageNote">
		<tr bgcolor="#E7E74" Height="5" style="border:none">
			<td width="100%" colspan="11" style="border:none">
				<font size="1">Message Annotation: </font>
			</td>
		</tr>
		<xsl:for-each select="Paragraph">
			<tr bgcolor="#33CCCCC" Height="5" style="border:none">
		...
		<xsl:if test="UsageExt">
			...
			<xsl:for-each select="UsageExt">
				<li>
					<font size="1">
				      XXX
					<xsl:value-of select="@Code"/><xsl:call-template name="nbsp"/>-<xsl:call-template name="nbsp"/>
					<xsl:value-of select="@Description"/>
					</font>
				</li>
			</xsl:for-each>
	...
	<xsl:template match="tableElement">
		<tr>
			<td width="2%">
				<font size="2"><xsl:call-template name="nbsp"/>
...
<xsl:template match="Diagrams">
		...
		<p/>
		<h3 align="center">
			<span style="background-color: #FFCC99">Diagrams</span>
		</h3>
		<p/>
...
<xsl:template match="Diagram">
		<p><h4> <xsl:value-of select="@title"/></h4></p>
