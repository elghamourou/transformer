...
<!-- This SS derived from MWBProfileFO is designed to produce output that matches Vista Spec submission Spread Sheet. Apply transfom in MWB, copy paste into Word, copy past into Excell template for Vista submission SS. -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html>
			<head>
				...
				<title>Vista Spread Sheet Template</title>
			</head>
			<body>
				<basefont face="Lucida Sans Unicode" size="2">
					<h2 align="center">
						<span style="background-color: #FFCC99">VistA Spread Sheet Template</span>
					</h2>
	...
	<xsl:template match="Segment">
		...
		<xsl:if test="@Optionality != 'NS'">
			<P align="center">
				<b>
					<font size="2">
						<span style="background-color: #FFCC99"><xsl:call-template name="nbsp"/></span>
					</font>
				</b>
			</P>
	...
	<xsl:template match="Field">
		<xsl:if test="@Optionality[.!='NS']">
			...
			<!-- Fields only   <xsl:apply-templates select="Component"/> -->
		</xsl:if>
		<xsl:if test="@Optionality[.='NS']">
			<tr bgColor="C0C0C0">
				<td width="25%">
	...
	<xsl:template match="Component">
		...
		<xsl:if test="@Optionality[.='NS']">
			<tr bgColor="C0C0C0">
				<td width="25%">
					<font size="1" color="C0C0C0"><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/></font>
					<font size="2" color="#0000FF">
						<xsl:value-of select="@Name"/>
					</font>
				</td>
	...
	<xsl:template match="SubComponent">
		...
		<xsl:if test="@Optionality[.='NS']">
			<tr bgColor="C0C0C0">
				<td width="25%">
					<font size="1" color="C0C0C0"><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/></font>
					<font size="2" color="#FF00FF">
						<xsl:value-of select="@Name"/>
					</font>
				</td>
  ...
  padding:.75pt .75pt .75pt .75pt;height:3.75pt">
					<font color="#00CC66"><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/></font>
	...
	<xsl:template match="HL7Definition">
		...
		<xsl:for-each select="Paragraph">
			<tr bgcolor="#33CCCCC" Height="5" style="border:none">
				<td width="100%" colspan="11" style="width:95.4%;border:none;background:#CCFFCC;
  padding:.75pt .75pt .75pt .75pt;height:3.75pt">
					<font color="#00FFFF"><xsl:call-template name="nbsp"/><xsl:call-template name="nbsp"/></font>
					<font size="1" color="#0000FF">
						<xsl:value-of select="."/>
					</font>
				</td>
